...
public:
    ...
    std::unordered_map<int, void*> m_rotateObjectsRelated;
    ...
    cocos2d::CCNode* m_swingFireMiddle;
    cocos2d::CCNode* m_swingFireBottom;
    cocos2d::CCNode* m_swingFireTop;
    cocos2d::CCSprite* m_dashSpritesContainer;
    cocos2d::CCMotionStreak* m_regularTrail;
    cocos2d::CCMotionStreak* m_shipStreak;
    cocos2d::CCNode* m_waveTrail;
    ...
    cocos2d::CCNode* m_pendingCheckpoint;
    ...
    int m_jumpRelatedAC2Rand;
    int m_jumpRelatedAC2Seed;
    int m_jumpRelatedAC2;
    bool m_touchedPad;
    double m_yVelocity;
    double m_fallSpeed;
    bool m_isOnSlope;
    ...
    cocos2d::CCNode* m_robotFire;
    int m_unkUnused;
    GJBaseGameLayer* m_gameLayer;
    cocos2d::CCLayer* m_parentLayer;
    cocos2d::CCNode* m_actionManager;
    ...
    void createRobot(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x366050)(this, p0);
    }
    ...
    void createSpider(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x366410)(this, p0);
    }
    ...
    void updatePlayerBirdFrame(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x37c2f0)(this, p0);
    }
    ...
    void updatePlayerDartFrame(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x37c9f0)(this, p0);
    }
    ...
    void updatePlayerFrame(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x37bc60)(this, p0);
    }
    ...
    void updatePlayerRollFrame(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x37c590)(this, p0);
    }
    ...
    void updatePlayerSwingFrame(int p0)
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*, int
            )>(redecore::getBase() + 0x37c7c0)(this, p0);
    }
    ...
    void updateRobotAnimationSpeed()
    {
        return reinterpret_cast<void(__fastcall*)(
            PlayerObject*
            )>(redecore::getBase() + 0x37f0f0)(this);
    }
};